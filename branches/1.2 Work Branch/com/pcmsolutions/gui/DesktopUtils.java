...
public class DesktopUtils {
    protected static final int UNUSED_HEIGHT = 16;
    protected static int nextX; // Next X position
    protected static int nextY; // Next Y position
    protected static final int DEFAULT_OFFSETX = 32;
    protected static final int DEFAULT_OFFSETY = 32;
            ...
            for (int i = comps.length - 1; i >= 0; i--) {
                ...
                if (comp instanceof JInternalFrame && comp.isVisible()) {
                    ...
                    if (--thisRow == 0) {
                        ...
                        // LinkProxy to smaller rows if necessary
                        if (--normalColumns <= 0) {
                            thisRow = rows + 1;
