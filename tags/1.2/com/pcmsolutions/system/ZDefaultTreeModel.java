/*
 * ZDefaultTreeModel.java
 *
 * Created on January 30, 2003, 7:59 PM
 */
 ...
 * @author Scott Violet
 */
public class ZDefaultTreeModel implements Serializable, TreeModel {
    /** Root of the tree. */
     ...
     */
    public ZDefaultTreeModel(TreeNode root) {
        this(root, false);
    }
     ...
     */
    public ZDefaultTreeModel(TreeNode root, boolean asksAllowsChildren) {
        super();
        this.root = root;
     ...
     * event. This is the preferred way to addDesktopElement children as it will create
     ...
     * The elementCount of the returned array gives the node's depth in the
     * tree.
     *
     ...
     * @param   l       the listener to addDesktopElement
     */
     ...
     * is lazily created using the parameterObjects passed into
     * the fire method.
     *
     ...
     * <code>addDesktopElement<em>Foo</em>Listener</code> method.
     *
     * <preset>
     *
     ...
     *
     * @param listenerType the type of listeners requested; this parameter2
