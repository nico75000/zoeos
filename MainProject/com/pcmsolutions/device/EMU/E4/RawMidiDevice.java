 ...
 */
class RawMidiDevice {
    // BOGUS - we broke compatibility with preset packages that contain multi-mode settings when we moved this class
    // must keep this here now for compatibility
    //
    //*************************
    // NEVER DELETE!!!!!!!!!!
    //*************************
    //
    static class Impl_MultiModeMap implements MultiModeMap, Serializable {
