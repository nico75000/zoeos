...
public class ZCommandRegistry {
    ...
    private static void makeClassStringMap() {
        ...
        classStringMap.put(E4ReadableSampleZCommandMarker.class, "com.pcmsolutions.device.EMU.E4.zcommands.sample.RefreshSampleZMTC;com.pcmsolutions.device.EMU.E4.zcommands.sample.AuditionSamplesZMTC"); //;com.pcmsolutions.device.EMU.E4.zcommands.sample.SampleToPresetZMTC");
            ...
            if (s != null) {
                ...
                while (tok.hasMoreElements()) {
                    ...
                    try {
                        ...
                        if (marker.isAssignableFrom(cls) && ZCommand.class.isAssignableFrom(cls))
                            classes.add(cls);
                        else
    ...
    public static void insert(ZCommand incoming, List<ZCommand> cmds) {
        for (ListIterator<ZCommand> i = cmds.listIterator(); i.hasNext();)
            if (incoming.overrides(i.next()))
                i.remove();
        cmds.add(incoming);
    }
