 ...
 */
public class ZDBModifyThread extends ZWaitThread {
    public static volatile int defaultPriority = 5;

    public ZDBModifyThread() {
        this("Unknown ZDBModifyThread");
    }

    public ZDBModifyThread(String name) {
        super(Zoeos.DBModifyTG, name);
        //setPriority(Zoeos.DBModifyTG.getMaxPriority());
