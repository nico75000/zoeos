 ...
 */
public class BlackMapVoiceGroupZMTC extends AbstractEditableVoiceZMTCommand {
    ...
    public String getDescriptiveString() {
        return "Map voices in group on black keys starting from low key of first voice in the group";
    }
    ...
    public boolean handleTarget(ContextEditablePreset.EditableVoice editableVoice, int total, int curr) throws Exception {
        ...
        PresetContextMacros.intervalMapGroupKeyWin(voices[0].getPresetContext(), voices[0].getPresetNumber(), grp, new IntervalServices.Mapper.Black(lowKey));
        return false;
    }
}
