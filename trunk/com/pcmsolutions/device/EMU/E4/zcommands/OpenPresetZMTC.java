...
public class OpenPresetZMTC extends AbstractReadablePresetZMTCommand {
    ...
    public OpenPresetZMTC() {
        super("Open", "Open the preset", null, null);
    }
    ...
    private void openPreset(final ReadablePreset p) throws NoSuchPresetException {
        //p.assertPresetInitialized();
        p.performOpenAction();
    }
