package com.pcmsolutions.gui.midisynth;
...
public class CapturePlayback extends JPanel implements ActionListener, ControlContext {
    ...
    public class Playback implements Runnable {
        ...
        public void run() {
            ...
            // get and assertOpen the source data line for playback.

            try {
                line = (SourceDataLine) AudioSystem.getLine(info);
                line.open(format, bufSize);
            } catch (LineUnavailableException ex) { 
                shutDown("Unable to assertOpen the line: " + ex);
                return;
            }
            ...
            // stop and referencedClose the line.
            if (thread != null) {
                line.drain();
            }
            line.stop();
    ...
    class Capture implements Runnable {
        ...
        public void run() {
            ...
            // get and assertOpen the target data line for capture.
            ...
            // we reached the end of the stream.  stop and referencedClose the line.
            line.stop();
            line.close();
            line = null;

            // stop and referencedClose the output stream
            try {
                out.flush();
                out.close();
