 ...
 * <br>
 * Required jar files: jide-common.jar, jide-dialogs.jar, jide-components.jar
 * <br>
...
public class FirebirdOptionsDialog extends MultiplePageDialog {
    ...
    public static void main(String[] args) {
        ...
        FirebirdOptionsDialog dialog = new FirebirdOptionsDialog(null, "Mozilla Firebird-like Option Dialog");
    ...
    private static CollapsiblePane createCollapsiblePane(String title) {
        ...
        pane1.setStyle(CollapsiblePane.TREE_STYLE);
        pane1.getUI().getTitlePane().setFocusable(false);
        ...
        ((JScrollPane) pane1.getActualComponent()).getViewport().setOpaque(false);
        return pane1;
    }
