...
public class PropertyPaneDemo extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        CellRendererManager.registerRenderer(Boolean.class, new CheckBoxCellRenderer());
        CellEditorManager.registerEditor(Boolean.class, new CheckBoxCellEditor());
        CellEditorManager.registerEditor(File.class, new FileNameCellEditor() {
