...
public class JideButtonDemo extends JFrame {
    ...
    private static JPanel createOptionsPanel() {
        ...
        header.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED, Color.white, Color.lightGray, Color.lightGray, Color.gray),
        ...
        final JComboBox lookAndFeelComboBox = new JComboBox(new String[]{
            "Windows L&F - VSNET style",
            "Windows L&F - Office 2003 style",
            "Windows L&F - Eclipse style",
            "Metal L&F",
            "Aqua L&F - Mac OS X only"
        });

        lookAndFeelComboBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int index = lookAndFeelComboBox.getSelectedIndex();
                try {
                    switch (index) {
                        case 0:
