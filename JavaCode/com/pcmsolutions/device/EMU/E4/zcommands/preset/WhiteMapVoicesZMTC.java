 ...
 */
public class WhiteMapVoicesZMTC extends AbstractEditableVoiceZMTCommand {
    ...
    public String getDescriptiveString() {
        return "Map voices on white keys starting from low key of first voice";
    }
    ...
    public boolean handleTarget(ContextEditablePreset.EditableVoice editableVoice, int total, int curr) throws Exception {
        ...
        PresetContextMacros.intervalMapVoiceKeyWin(voices, new IntervalServices.Mapper.White(voices[0].getVoiceParams(new Integer[]{ID.lowKey})[0].intValue()));
        return false;
    }
}
